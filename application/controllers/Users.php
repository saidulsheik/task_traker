...
class Users extends Admin_Controller 
{
	...
	public function edit($id = null)
	{
		...
		if($id) {
			...
			if(trim($this->input->post('edit_email')) != trim($this->input->post('old_email'))){
				$this->form_validation->set_rules('edit_email', 'User Email', 'trim|required|is_unique[users.email]');
			} else {
				$this->form_validation->set_rules('edit_email', 'User Email', 'trim|required');
			}
