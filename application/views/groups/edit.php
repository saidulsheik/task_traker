                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Project</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createProject" <?php if($serialize_permission) {
                          if(in_array('createProject', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateProject" <?php if($serialize_permission) {
                          if(in_array('updateProject', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewProject" <?php if($serialize_permission) {
                          if(in_array('viewProject', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteProject" <?php if($serialize_permission) {
                          if(in_array('deleteProject', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Module</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createModule" <?php if($serialize_permission) {
                          if(in_array('createModule', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateModule" <?php if($serialize_permission) {
                          if(in_array('updateModule', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewModule" <?php if($serialize_permission) {
                          if(in_array('viewModule', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteModule" <?php if($serialize_permission) {
                          if(in_array('deleteModule', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Module Status</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createModuleStatus" <?php if($serialize_permission) {
                          if(in_array('createModuleStatus', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateModuleStatus" <?php if($serialize_permission) {
                          if(in_array('updateModuleStatus', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewModuleStatus" <?php if($serialize_permission) {
                          if(in_array('viewModuleStatus', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteModuleStatus" <?php if($serialize_permission) {
                          if(in_array('deleteModuleStatus', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <tr>
                        <td>Tasks Levels</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createTasksLabels" <?php if($serialize_permission) {
                          if(in_array('createTasksLabels', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateTasksLabels" <?php if($serialize_permission) {
                          if(in_array('updateTasksLabels', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewTasksLabels" <?php if($serialize_permission) {
                          if(in_array('viewTasksLabels', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteTasksLabels" <?php if($serialize_permission) {
                          if(in_array('deleteTasksLabels', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>

                      <tr>
                        <td>Tasks Priority</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createTasksPriority" <?php if($serialize_permission) {
                          if(in_array('createTasksPriority', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateTasksPriority" <?php if($serialize_permission) {
                          if(in_array('updateTasksPriority', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewTasksPriority" <?php if($serialize_permission) {
                          if(in_array('viewTasksPriority', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteTasksPriority" <?php if($serialize_permission) {
                          if(in_array('deleteTasksPriority', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
                      <!--tr>
                        <td>Category</td>
